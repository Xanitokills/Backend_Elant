...
INSERT INTO MAE_USUARIO (NRO_DPTO, NOMBRES, APELLIDOS, DNI, CORREO, CELULAR, CONTACTO_EMERGENCIA, FECHA_NACIMIENTO, ID_TIPO_USUARIO, ID_SEXO, DETALLE, OBSERVACIONES, COMITE, USUARIO, CONTRASENA_HASH, CONTRASENA_SALT, ESTADO)
VALUES (101, 'Juan', 'Pérez', '12345678', 'juan@example.com', '987654321', '912345678', '1990-01-01', 1, 1, 'Residente principal', 'Ninguna', 0, 'juanperez', 'hash123', 'salt123', 1);
...
DELETE FROM MAE_USUARIO WHERE ID_USUARIO = 1
...
VALUES (
    ...
    0, -- COMITE (0 = No)
    'juanperez', -- USUARIO
    '$2b$10$J22rsc5zqm3COkERoc4DuOKoBqwzj6N1HbqPjBWIRI5CsoNhZH/42', -- CONTRASENA_HASH
...
ALTER TABLE MAE_USUARIO
ADD CONTRASENA_HASH VARCHAR(255) NOT NULL,
    CONTRASENA_SALT VARCHAR(50) NOT NULL;
