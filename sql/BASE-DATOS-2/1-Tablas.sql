...
--INSERTAR Dashboard PARA TODOS
INSERT INTO MAE_MENU (NOMBRE, ICONO, URL, ORDEN, ESTADO)
VALUES ('Dashboard', 'FaHome', '/dashboard', 0, 1);


INSERT INTO MAE_ROL_MENU (ID_TIPO_USUARIO, ID_MENU)
SELECT ID_TIPO_USUARIO, (SELECT ID_MENU FROM MAE_MENU WHERE NOMBRE = 'Dashboard')
FROM MAE_TIPO_USUARIO
WHERE ID_TIPO_USUARIO IN (1, 2, 3, 4, 5, 6)
  AND ID_TIPO_USUARIO NOT IN (
    SELECT ID_TIPO_USUARIO 
    FROM MAE_ROL_MENU 
    WHERE ID_MENU = (SELECT ID_MENU FROM MAE_MENU WHERE NOMBRE = 'Dashboard')
  );
