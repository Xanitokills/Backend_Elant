...
CREATE TRIGGER TRG_UPCASE_NOMBRE_VISITANTE
ON MAE_VISITA_PROGRAMADA
AFTER INSERT, UPDATE
AS
BEGIN
    UPDATE MAE_VISITA_PROGRAMADA
    SET NOMBRE_VISITANTE = UPPER(i.NOMBRE_VISITANTE)
    FROM MAE_VISITA_PROGRAMADA m
    INNER JOIN inserted i ON m.ID_VISITA_PROGRAMADA = i.ID_VISITA_PROGRAMADA
    WHERE m.NOMBRE_VISITANTE != UPPER(i.NOMBRE_VISITANTE);
END;