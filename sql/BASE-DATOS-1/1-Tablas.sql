...
-- 🚪 Tabla MAE_VISITA (Visits actualizada con ID_USUARIO_PROPIETARIO obligatorio)
...
(
    ...
    ID_USUARIO_REGISTRO INT NOT NULL,         -- Quien registra la visita
    ID_USUARIO_PROPIETARIO INT NOT NULL,       -- A quién visitan (el dueño del dpto)
    ESTADO BIT NOT NULL CHECK (ESTADO IN (0, 1)),

    -- Claves foráneas
    CONSTRAINT FK_VISITA_USUARIO_REGISTRO FOREIGN KEY (ID_USUARIO_REGISTRO) 
        REFERENCES MAE_USUARIO(ID_USUARIO) ON DELETE NO ACTION,

    CONSTRAINT FK_VISITA_USUARIO_PROPIETARIO FOREIGN KEY (ID_USUARIO_PROPIETARIO) 
        REFERENCES MAE_USUARIO(ID_USUARIO) ON DELETE NO ACTION,

    -- Restricción de lógica de tiempo
